...
//================= { TIME } =================\\
const time2 = moment().tz("Africa/Jakarta").format("HH:mm:ss")
let ucapangreet
...
const wib = moment(Date.now()).tz("Africa/Dakar").locale("id").format("HH:mm:ss z")
const wita = moment(Date.now()).tz("Africa/Abidjan").locale("id").format("HH:mm:ss z")
